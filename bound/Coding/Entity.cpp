...
struct Switch : public Entity
{
    ...
    //type 4 is a cancel switch
	Switch(const char* filename, int startPosX, int startPosY, int platformNumber, int type)
	{
        ...
        eTexture2.loadFromFile("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/Stage_Images/Universal_StageParts/Switch_Hit.png");
	...
	Switch(const char* filename, int startPosX, int startPosY, int type, int displacementX, int displacementY)
	{
		eTexture.loadFromFile(filename);
		eTextureSize = eTexture.getSize();
		eSprite.setTexture(eTexture);
...
struct Oven : public Entity
{
	...
	{
        eTexture.loadFromFile("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/Stage_Images/Universal_StageParts/Stage_Oven_Default.png");
...
struct Portal : public Entity 
{
	...
	Portal(int startPosX, int startPosY, int type)
	{
		...
		{
			portalType = 0;
			eTexture.loadFromFile("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/Stage_Images/Universal_StageParts/Portal_Baker.png");
		}
		if (type==1)
		{
			portalType = 1;
			eTexture.loadFromFile("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/Stage_Images/Universal_StageParts/Portal_Roti.png");
		}
		if (type==2) 
		{
			portalType = 2;
			eTexture.loadFromFile("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/Stage_Images/Universal_StageParts/Portal_Anpan.png");
		}
...
struct Baker : public Entity
{
	Baker()
	{
		eTexture.loadFromFile("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/Character_Images/TheBaker.png");
...
struct Roti : public Entity
{
	Roti()
	{
		...
		eTexture2.loadFromFile("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/Stage_Images/Universal_StageParts/Roti_Selected.png");
		...
		eNotCreatedTexture.loadFromFile("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/Stage_Images/Universal_StageParts/Missing_Roti.png");
	...
	void create() //blank constructor, same for other 2
	{
		...
		eTexture.loadFromFile("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/Character_Images/Roti.png");		
...
struct Anpan : public Entity
{
	Anpan()
	{
		...
		//BreadSelector Initialisation
		eTexture2.loadFromFile("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/Stage_Images/Universal_StageParts/Anpan_Selected.png");
		eTextureSize2 = eTexture2.getSize();
		eSprite2.setTexture(eTexture2);
		eSprite2.setOrigin(eTextureSize2.x/2,eTextureSize2.y/2);
		...
		bottomLLCircle = new float[2];
		bottomRRCircle = new float[2];
		eNotCreatedTexture.loadFromFile("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/Stage_Images/Universal_StageParts/Missing_Anpan.png");
		eNotCreated.setTexture(eNotCreatedTexture);
		//----------------------------
	}
	void create()
	{
		...
		eTexture.loadFromFile("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/Character_Images/Anpan.png");
...
struct Boule : public Entity
{
	Boule()
	{
		...
		//BreadSelector Initialisation
		eTexture2.loadFromFile("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/Stage_Images/Universal_StageParts/Boule_Selected.png");
		eTextureSize2 = eTexture2.getSize();
		eSprite2.setTexture(eTexture2);
		eSprite2.setOrigin(eTextureSize2.x/2,eTextureSize2.y/2);
	...
	void create()
	{
		...
		eTexture.loadFromFile("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/Character_Images/Boule.png");
