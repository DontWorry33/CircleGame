...
struct UI
{
	...
	virtual int isTouchingOption(){return 0;}; //ONLY CALL ONCE WIN AIS INSTANTIANATED
	virtual void render(){};
	virtual void fade(){};
...
struct Main_Menu : UI
{
	...
	Main_Menu(int winX, int winY)
	{
		...
		UI_bkg_img.loadFromFile("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/User_Interfaces/Main_Menu/Menu-Default.png");
		UI_bkg.setTexture(UI_bkg_img);
		new_game = new Option("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/User_Interfaces/Main_Menu/Menu-NewGame.png", 62, 136, 240, 179);
		UI_options.push_back(new_game);
		about = new Option("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/User_Interfaces/Main_Menu/Menu-About.png", 62, 179, 240, 222);
		UI_options.push_back(about);
		tutorials  = new Option("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/User_Interfaces/Main_Menu/Menu-Tutorials.png", 62, 222, 240, 260);
		UI_options.push_back(tutorials);
		quit = new Option("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/User_Interfaces/Main_Menu/Menu-Quit.png", 62, 260, 240, 300);
...
struct Tutorial_Menu : UI
{
	...
	{
		win = curr_win;
		main = new Option("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/User_Interfaces/Tutorial_Screens/Tutorial_Main.png");
		UI_options.push_back(main);
		hud = new Option("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/User_Interfaces/Tutorial_Screens/Tutorial_HUD.png");
		UI_options.push_back(hud);
		controls = new Option("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/User_Interfaces/Tutorial_Screens/Tutorial_Controls.png");
		UI_options.push_back(controls);
		dream = new Option("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/User_Interfaces/Tutorial_Screens/Tutorial_Dream.png");
		UI_options.push_back(dream);
		lie = new Option("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/User_Interfaces/Tutorial_Screens/Tutorial_Lie.png");
		UI_options.push_back(lie);
		wish = new Option("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/User_Interfaces/Tutorial_Screens/Tutorial_Wish.png");
		UI_options.push_back(wish);
		switches = new Option("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/User_Interfaces/Tutorial_Screens/Tutorial_Switches.png");
...
struct AboutPage : UI
{
	...
	{
		win = curr_win;
		UI_bkg_img.loadFromFile("C:/Users/dontworry/Documents/Visual Studio 2012/Projects/proj1/User_Interfaces/Main_Menu/AboutPage.png");
		UI_bkg.setTexture(UI_bkg_img);
